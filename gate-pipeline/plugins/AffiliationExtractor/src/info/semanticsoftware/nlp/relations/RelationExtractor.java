/*
 * Semantic Software Lab submission to Semantic Publishing Challenge 2015,
...
package info.semanticsoftware.nlp.relations;
...
/** 
 * This class is the implementation of the resource AffiliationExtractor.
 */
@CreoleResource(name = "AffiliationExtractor",
        comment = "Detects which author is employeed by an organization.")
public class RelationExtractor  extends AbstractLanguageAnalyser
  implements ProcessingResource {
	...
	public void execute() throws ExecutionException {
		...
		AnnotationSet affiliations = annotSet.get("Affiliation");
